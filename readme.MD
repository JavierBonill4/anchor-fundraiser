...
At 25%, 50%, and 75% of the fundraising target. The frontend can listen for the event and display the achievement. Each milestone fires only once, and refunds do not undo a milestone.